...
def numba_precompile_three():
    actual_values = [250,250,250,250]
    z_0 = 50
...
def get_s11eq_three(f, z_0, z0, zv_1, zh_1, zv_2, zh_2):
...
def get_s21eq_three(f, z_0, z0, zv_1, zh_1, zv_2, zh_2):
...
def get_s31eq_three(f, z_0, z0, zv_1, zh_1, zv_2, zh_2):
...
def get_s41eq_three(f, z_0, z0, zv_1, zh_1, zv_2, zh_2):
...
def qhdc_plotter_three(derived_imp, eps_r, f_res, z_0):
    #input
